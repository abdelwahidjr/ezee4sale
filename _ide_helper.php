 ...
 * Generated for Laravel 5.7.13 on 2018-11-27 17:04:29.
 *
...
namespace Jimmyjs\ReportGenerator\Facades { 
    ...
    class PdfReportFacade {
         ...
         * @static 
         */ 
        public static function showNumColumn($value = true)
        {
            //Method inherited from \Jimmyjs\ReportGenerator\ReportGenerator            
            return \Jimmyjs\ReportGenerator\ReportMedia\PdfReport::showNumColumn($value);
        }
    ...
    class ExcelReportFacade {
         ...
         * @static 
         */ 
        public static function make($filename, $simpleVersion = false)
        {
            return \Jimmyjs\ReportGenerator\ReportMedia\ExcelReport::make($filename, $simpleVersion);
        }
        ...
        {
            //Method inherited from \Jimmyjs\ReportGenerator\ReportGenerator            
            return \Jimmyjs\ReportGenerator\ReportMedia\ExcelReport::showNumColumn($value);
        }
    ...
    class CSVReportFacade {
        ...
        {
            //Method inherited from \Jimmyjs\ReportGenerator\ReportGenerator            
            return \Jimmyjs\ReportGenerator\ReportMedia\CSVReport::showNumColumn($value);
        }
