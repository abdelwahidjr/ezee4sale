...
use Tests\DesignPatterns\Behavioral\Iterator\BookListIterator;
use Tests\DesignPatterns\Behavioral\Iterator\BookListReverseIterator;
...
class IteratorTest extends TestCase
{
    public function testCanIterateOverBookList()
    {
        ...
        $bookList->addBook(new Book('Learning PHP Design Patterns' ,
            'William Sanders'));
        $bookList->addBook(new Book('Professional Php Design Patterns' ,
            'Aaron Saray'));
